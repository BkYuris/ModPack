...
class FreeplayState2 extends MusicBeatState
{
	...
	override function create()
	{
		...
		Paths.destroyLoadedImages();
 		#end	
		ModsWeekData.reloadWeekFiles(false);
		#if desktop
		// Updating Discord Rich Presence
		DiscordClient.changePresence("In the Menus", null);
		#end

		for (i in 0...ModsWeekData.weeksList.length) {
			var leWeek:ModsWeekData = ModsWeekData.weeksLoaded.get(ModsWeekData.weeksList[i]);
			...
			ModsWeekData.setDirectoryFromWeek(leWeek);
		...
		ModsWeekData.setDirectoryFromWeek();
	...
	override function update(elapsed:Float)
	{
		...
		else #end if (accepted)
		{
			...
			trace('CURRENT WEEK: ' + ModsWeekData.getWeekFileName());
			if(colorTween != null) {
				colorTween.cancel();
			}
